...
var KTFileManagerList=function(){
    var e,t,o,n,r,a;
    const l=()=>{
        t.querySelectorAll('[data-kt-filemanager-table-filter="delete_row"]').
        forEach(
            (t=>{
        ...
        r.forEach((e=>{
            e.checked&&(a=!0,l++)
        })), a?(n.innerHTML=l,e.classList.add("d-none"),o.classList.remove("d-none")):
        ...
        l.innerHTML=s.innerHTML,a.querySelector("#kt_file_manager_rename_input").value=r;
            ...
            t.querySelectorAll('[data-kt-filemanger-table="copy_link"]').forEach((e=>{
                ...
                t.addEventListener("click",(e=>{
                    ...
                    e.preventDefault(),o.classList.remove("d-none"),n.classList.add("d-none"),clearTimeout(t),t=setTimeout((()=>{
                        o.classList.add("d-none"),n.classList.remove("d-none"),r.select()}),2e3)
                }))
            }))
        },f=()=>{
                    ...
                    d.addEventListener("click",(t=>{
                        ...
                        g&&g.validate().then((function(t){
                            ...
                            "Valid"==t?setTimeout((function(){
                                ...
                                for(
                                    var n,l=e.row(0).index(),i=e.data().length-1,s=e.row(i).data(),c=i;c>l;c--
                                )
